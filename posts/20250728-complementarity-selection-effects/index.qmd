...
There, we have now put everything together. Now that all the bits are explained and everything is in its right place, let's move them around a bit to understand the logic of this partitioning. Before we do that, it will help to know that the expected value of the product of two random variables is equal to the product of the expected values of each variable plus their covariance:
